...
\input{macro/structure_jp.tex} % Include the file that specifies the document structure
...
\headerlineone{\textsc{Ecole}} % Top header line, leave blank if you only want the bottom line

\headerlinetwo{\textsc{polytechnique}} % Bottom header line
